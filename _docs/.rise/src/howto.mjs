...
<li class='false'>
    ...
    <div class='wrapper'>
        <h1 id="how-to-use-rise-aws-foundation">How to use Rise AWS Foundation</h1>
<h2 id="introduction">Introduction</h2>
<p>Rise AWS Foundation helps you:</p>
<ul>
<li>Create AWS resources</li>
<li>Act on those AWS resources</li>
</ul>
<h2 id="creating-aws-resources">Creating AWS resources</h2>
<p>CloudFormation is the best way to create resources in aws. Without Cloudformation,
...
<p>For these reasons, Rise AWS Foundation has no methods for creating AWS resources with
the sdk directly, but instead has methods for creating CloudFormation templates snippets. Once all AWS resources are defined in templates snippets, we can combine them into 1 template and use the CloudFormation methods to deploy that template.</p>
<h3 id="how-cloudformation-is-created-in-aws-foundation">How CloudFormation is created in AWS Foundation</h3>
<p>These create methods will always return the following:</p>
<pre class="hljs language-js"><code class="hljs language-js">const result = exampleResource.cf.create()
...
<pre class="hljs language-js"><code class="hljs language-js">const result1 = lambda.makeLambda()
...
<p>We can now deploy this template using the CloudFormation methods in AWS Foundation:</p>
<pre class="hljs language-js"><code class="hljs language-js">import * as aws from &#39;rise-aws-foundation&#39;
