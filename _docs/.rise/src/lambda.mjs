...
<p>There are many ways to run your code on the cloud. Rise AWS Foundation purposely only provides 1 option, AWS Lambda. Lambda functions are:</p>
<ul>
<li>pay per execution</li>
<li>can scale automatically</li>
<li>cost nothing if they are not triggered</li>
<li>are a managed service. You only need to care about code, you dont have to care about operating systems, patching, or any server configuration.</li>
<li>is cheap (first 1 million invocations a month are free)</li>
</ul>
...
<h2 id="lambdamakelambda">lambda.makeLambda</h2>
<pre class="hljs language-js"><code class="hljs language-js">import * as aws from &#39;rise-aws-foundation&#39;
...
<h2 id="lambdamakeinlinelambda">lambda.makeInlineLambda</h2>
<pre class="hljs language-js"><code class="hljs language-js">import * as aws from &#39;rise-aws-foundation&#39;
...
<h2 id="lambdainvokelambda">lambda.invokeLambda</h2>
<pre class="hljs language-js"><code class="hljs language-js">import * as aws from &#39;rise-aws-foundation&#39;
