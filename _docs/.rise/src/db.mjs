...
<p>Its common to require a database in serverless apps. DynamoDB is the best option
as it is itself a serverless service that does not require much supervision. This
abstraction is built with single table design in mind.</p>
<p>This abstraction also comes with a special keyword to help create uuid&#39;s. If <code>@id</code> is included in a string, these functions will be replaced that keyword with a unique id on every execution.</p>
<p>This abstratcion also assumes your database has the following schema:</p>
<ul>
<li><p>PartitionKey: pk</p>
</li>
<li><p>SortKey: sk</p>
</li>
<li><p>GSI1: pk2</p>
</li>
<li><p>SortKey on GSI1: sk</p>
</li>
<li><p>GSI2: pk3</p>
</li>
<li><p>SortKey on GSI1: sk</p>
...
<h2 id="dbget">db.get</h2>
<pre class="hljs language-js"><code class="hljs language-ts">import * as aws from &#39;rise-aws-foundation&#39;
const item = await aws.db.get({
    pk: &#39;note&#39;,
    sk: &#39;note_1234&#39;
})
</code></pre>
<h2 id="dblist">db.list</h2>
<p>Query with begins_with on the sk</p>
<pre class="hljs language-js"><code class="hljs language-ts">import * as aws from &#39;rise-aws-foundation&#39;
