...
<p>CloudFormation is the way we deploy things into an AWS account. Every other resource within &quot;rise-aws-foundations&quot; has methods that will create JSON objects representing AWS resources. With this information, we can deploy a Cloudformation stack.</p>
