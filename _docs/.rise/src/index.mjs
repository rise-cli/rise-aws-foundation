...
<p><a href="https://github.com/rise-cli/rise-aws-foundation">Github</a></p>
<p>The aws sdk gives us a lot of power and options. This is a good thing, but can also
be overwhelming. The purpose of this project is to provide a layer on top of the sdk that is:</p>
<ul>
<li>opinionated</li>
<li>focused</li>
<li>stable</li>
</ul>
<p>The goal is to change the experience of building with aws. Instead of feeling heavy and complicated, the aim is to make building with aws feel light and simple.</p>
<h2 id="installation">Installation</h2>
<p>You can use aws foundation in your project by npm installing it:</p>
<pre class="hljs language-bash"><code class="hljs language-bash">npm i rise-aws-foundation
</code></pre>
