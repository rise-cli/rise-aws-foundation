...
can be represented as a JSON object, this is not the service to use (although, sometimes poeple will dump GB of data into s3 for analytics, usually in the form of a zip file). If your data can be represented as an object, DynamoDB is the service for you. If not, then S3 is a good service to consider.</p>
...
<h2 id="s3makesimplebucket">s3.makeSimpleBucket</h2>
<pre class="hljs language-js"><code class="hljs language-js">import * as aws from &#39;rise-aws-foundation&#39;
const s3 = rise.s3.makeSimpleBucket(&#39;myBucketName&#39;)
</code></pre>
<h2 id="s3makebucket">s3.makeBucket</h2>
